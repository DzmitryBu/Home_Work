...
public class CalculatorWithCounterAutoCompositeInterfaceMain {
    public static void main(String[] args) {
        ...
        CalculatorWithCounterAutoAgregationInterface calc1 = new CalculatorWithCounterAutoAgregationInterface(x1);
        ...
        CalculatorWithCounterAutoAgregationInterface calc2 = new CalculatorWithCounterAutoAgregationInterface(x2);
        ...
        CalculatorWithCounterAutoAgregationInterface calc3 = new CalculatorWithCounterAutoAgregationInterface(x3);
